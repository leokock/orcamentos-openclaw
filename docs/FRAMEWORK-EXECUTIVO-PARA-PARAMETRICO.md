# FRAMEWORK-EXECUTIVO-PARA-PARAMETRICO.md — REDIRECT

> **Movido pra `~/openclaw/docs/orcamento/QUANTITATIVOS-E-PRECIFICACAO.md` em 2026-05-27.**
>
> Framework de extração de índices absorvido na seção "Framework: Extração de Índices Executivo → Paramétrico".
>
> O conteúdo original foi preservado em `~/orcamentos-openclaw/archive/2026-05-cleanup/docs-pre-fusao/FRAMEWORK-EXECUTIVO-PARA-PARAMETRICO.md`.
...
- **Doc canônico:** `~/openclaw/docs/orcamento/QUANTITATIVOS-E-PRECIFICACAO.md`
