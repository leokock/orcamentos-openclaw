# AGENTS-EXECUTIVO-DETAIL.md — REDIRECT

> **Movido pra `~/openclaw/docs/orcamento/EXECUTIVO.md` em 2026-05-27.**
>
> Workflow detalhado executivo absorvido no doc canônico. Regras do bot Slack continuam em AGENTS.md.
>
> O conteúdo original foi preservado em `~/orcamentos-openclaw/archive/2026-05-cleanup/docs-pre-fusao/AGENTS-EXECUTIVO-DETAIL.md`.
...
- **Doc canônico:** `~/openclaw/docs/orcamento/EXECUTIVO.md`
