# LICOES-APRENDIDAS-OXFORD.md — REDIRECT

> **Movido pra `~/openclaw/docs/orcamento/EXECUTIVO.md` em 2026-05-27.**
>
> Lições absorvidas na seção "Lições aprendidas — Caso Oxford 600 Residence" do EXECUTIVO.md.
>
> O conteúdo original foi preservado em `~/orcamentos-openclaw/archive/2026-05-cleanup/docs-pre-fusao/LICOES-APRENDIDAS-OXFORD.md`.
