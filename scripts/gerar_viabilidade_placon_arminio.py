...
Consome: parametrico-placon-arminio-tavares.xlsx + premissas-viabilidade.json
Produz : viabilidade-placon-arminio-tavares-v1.xlsx (analítico 7 abas)
         viabilidade-placon-arminio-tavares-v1-didatico.xlsx (didático 9 abas)
...
# PATHS
# ============================================================================
PACOTE_DIR = Path(r"C:\Users\leona\orcamentos-openclaw\base\pacotes\placon-arminio-tavares")
DRIVE_DIR = Path(
    r"G:\Drives compartilhados\03 CTN Projetos\2. Projetos em Andamento"
    r"\_Parametrico_IA\arminio-tavares"
)
...
PARAMETRICO_XLSX = PACOTE_DIR / "parametrico-placon-arminio-tavares.xlsx"
PREMISSAS_JSON = PACOTE_DIR / "premissas-viabilidade.json"
OUTPUT_XLSX = PACOTE_DIR / "viabilidade-placon-arminio-tavares-v1.xlsx"
OUTPUT_XLSX_V2 = PACOTE_DIR / "viabilidade-placon-arminio-tavares-v1-didatico.xlsx"
...
CUSTO_OBRA_FALLBACK = 17_865_737.68
...
def build_capa(ws, prem, kpis, mc_stats):
    ...
    r += 2
    ws.merge_cells(f"A{r}:F{r}")
    c = ws.cell(row=r, column=1, value="Fonte custo: parametrico-placon-arminio-tavares.xlsx CUSTOS_MACROGRUPO!D22")
    c.font = FONT_SMALL
