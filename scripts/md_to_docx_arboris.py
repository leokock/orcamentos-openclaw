...
if __name__ == '__main__':
    ...
    files = [
        ('PREMISSAS-ORIGEM.md', 'arthen-arboris-PREMISSAS-ORIGEM-v4.docx'),
        ('JUSTIFICATIVA-ITENS-ACIMA-DA-MEDIA.md', 'arthen-arboris-JUSTIFICATIVA-ITENS-ACIMA-MEDIA-v4.docx'),
    ]
