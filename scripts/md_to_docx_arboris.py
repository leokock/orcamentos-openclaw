...
if __name__ == '__main__':
    ...
    files = [
        ('PREMISSAS-ORIGEM.md', 'arthen-arboris-PREMISSAS-ORIGEM-final.docx'),
        ('JUSTIFICATIVA-ITENS-ACIMA-DA-MEDIA.md', 'arthen-arboris-JUSTIFICATIVA-ITENS-ACIMA-MEDIA-final.docx'),
    ]
