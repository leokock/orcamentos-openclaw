...
MG_CANON = [
    ...
    ("Revestimentos Parede", ["rev. int. parede", "revestimentos internos em paredes", "reboco interno",
    ...
    ("Pintura Interna", ["pintura interna", "sistemas de pintura interna", "pinturas"]),
