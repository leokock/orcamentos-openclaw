...
- **Mediana total:** R$ 37,718,511
- Faixa: R$ 4,958,344 — R$ 95,548,670
...
| Indicador | Mediana | n |
|---|---:|---:|
| Concreto (m³/m² AC) | 0.285 | 19 |
| Taxa aço (kg/m³ concreto) | 78.3 | 21 |
| Forma (m²/m² AC) | 2.123 | 18 |
...
|---|---:|---:|---|---|
| `all-acacias-jk` | 1,943 | N/D | rv_medio_alto | Florianópolis |
| `alto-ribeirao` | 22,728 | N/D | residencial_misto | Florianópolis |
| `arv-ingleses-spot` | 2,618 | N/D | rv_medio_alto | Florianópolis |
...
| `fg-blue-coast` | 13,132 | N/D | rv_medio | Florianópolis |
...
| `neuhaus-origem` | 14,559 | R$ 4,642 | rv_alto | Florianópolis |
| `nm-empreendimentos` | 1,541 | R$ 3,218 | rv_alto | Florianópolis |
| `nova-empreendimentos-domus` | 5,009 | R$ 7,668 | rv_medio_alto | Florianópolis |
...
| `parkside-trindade` | 3,333 | R$ 3,756 | rv_medio_alto | Florianópolis |
...
- Em `SC-Floripa`, empreendimentos _misto_ custam tipicamente **R$ 3,799/m²** (faixa p25-p75: R$ 3,218–R$ 5,247).
- CV 0.36 — variação **alta**. Projetos nesta combinação são heterogêneos; usar com cuidado.
- ✓ Amostra razoável (n=32) — benchmark estatisticamente útil.
