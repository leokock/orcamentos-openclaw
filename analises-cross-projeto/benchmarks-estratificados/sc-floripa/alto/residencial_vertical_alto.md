...
- Faixa: R$ 1,603,247 — R$ 206,674,002
...
| Taxa aço (kg/m³ concreto) | 80.5 | 10 |
...
| `caledonia-mowe-caledonia-mowe` | 330 | R$ 4,865 | rv_alto | Florianópolis |
| `dimas-pb2` | 21,215 | R$ 4,345 | rv_alto | Florianópolis |
| `fg-scenarium` | 42,278 | R$ 4,888 | rv_alto | Florianópolis |
...
- Em `SC-Floripa`, empreendimentos alto residencial_vertical_alto custam tipicamente **R$ 4,865/m²** (faixa p25-p75: R$ 4,345–R$ 5,247).
- CV 0.20 — variação **moderada**. Bom benchmark mas considerar escopo.
