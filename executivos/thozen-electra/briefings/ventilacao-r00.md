# Briefing: VENTILAÇÃO MECÂNICA (Escadas Pressurizadas) — Thozen Electra — R05
...
- **Data:** 2026-03-20
- **Fonte dos dados:** RA_EVM_LEGAL_PROJETO_R05.dwg
...
## ⚠️ AVISO IMPORTANTE — Limitação de Extração
...
**Razão:** O arquivo DWG fornecido não pôde ser processado com as ferramentas disponíveis para extração automática de dados estruturados (quantidades, especificações técnicas, potências, vazões). Foram testadas múltiplas abordagens de parsing sem sucesso.

**Próximos passos necessários:**
1. **CRÍTICO:** Validar os quantitativos abaixo com o projeto executivo (RA_EVM_LEGAL_PROJETO_R05.dwg)
2. Ajustar potências, vazões e especificações conforme memorial descritivo do projetista
3. Confirmar número de escadas pressurizadas no edifício
4. Verificar se há sistemas adicionais (ante-câmaras, outras escadas)
5. Obter planilha de equipamentos do projetista, se disponível
...
**Sistema estimado:**
- **Escadas pressurizadas:** 2 unidades (premissa: edifício residencial típico)
- **Ventiladores:** 1 por escada (total: 2 ventiladores)
...
## 2. Quantitativos Extraídos (PREMISSAS — VALIDAR COM PROJETO)
...
|---|------|--------------|-----|-----|-------|------------|
| 1 | Ventilador centrífugo de pressurização | Vazão: 8.000-12.000 m³/h, Pressão: 400-600 Pa, Potência: 5-7,5 CV | un | 2 | Premissa NBR 14880 | 1 por escada |
| 2 | Base antivibrante para ventilador | Concreto + amortecedores | un | 2 | Premissa | 1 por ventilador |
| 3 | Tomada de ar externa com veneziana | Alumínio, tela anti-insetos | un | 2 | Premissa | 1 por ventilador |
| 4 | Silenciador acústico | Atenuação mínima 20 dB | un | 2 | Premissa | Entrada dos ventiladores |
...
⚠️ **ATENÇÃO:** Metragens estimadas com base em altura típica de pé-direito. Validar com projeto arquitetônico.

| # | Item | Especificação | UN | QTD | Fonte | Observação |
|---|------|--------------|-----|-----|-------|------------|
| 1 | Duto vertical principal | Chapa #18 (1,2mm), Ø600mm, galvanizado, estanque | m | 200 | Premissa | 100m x 2 escadas (altura total ~95m + reserva) |
| 2 | Isolamento térmico de dutos | Lã de vidro 50mm + revestimento aluminizado | m² | 380 | Premissa | Área externa dos dutos verticais |
| 3 | Duto de derivação para antecâmaras | Chapa #20 (0,9mm), seção retangular 400x300mm | m | 60 | Premissa | ~2m x 15 derivações x 2 escadas |
| 4 | Curvas 90° para dutos Ø600mm | Chapa #18, raio longo, galvanizada | un | 6 | Premissa | 3 por sistema |
| 5 | Suportes para dutos verticais | Aço estrutural, fixação química | un | 64 | Premissa | A cada 3m (32 pav x 2 escadas) |
| 6 | Juntas de dilatação | Lona flexível, resistente a 300°C | un | 4 | Premissa | A cada 25m de duto vertical |
...
⚠️ **ATENÇÃO:** Quantidade e localização estimadas. Validar com projeto executivo.

| # | Item | Especificação | UN | QTD | Fonte | Observação |
|---|------|--------------|-----|-----|-------|------------|
| 1 | Grelha de insuflamento para escada | Alumínio anodizado, 600x400mm, regulável | un | 12 | Premissa | ~6 grelhas x 2 escadas (a cada 5 pav) |
| 2 | Difusor de teto para antecâmara | Aço, Ø300mm, aletas ajustáveis | un | 30 | Premissa | 15 pavimentos x 2 escadas (se aplicável) |
| 3 | Plenum de distribuição | Chapa #20, 800x600x400mm | un | 12 | Premissa | 1 por grelha principal |
...
| # | Item | Especificação | UN | QTD | Fonte | Observação |
|---|------|--------------|-----|-----|-------|------------|
| 1 | Damper corta-fogo 90min | Ø600mm, acionamento termomagnético (fusível 72°C) | un | 64 | Premissa | A cada pavimento x 2 escadas |
| 2 | Damper de regulagem (balanceamento) | Ø600mm, manual, com indicador de posição | un | 12 | Premissa | Derivações principais |
| 3 | Damper motorizado (sobrепressão) | Ø600mm, 24Vdc, modulante | un | 4 | Premissa | Controle de pressão (2 por escada) |
| 4 | Atuador elétrico para damper | 24Vdc, torque 10Nm, feedback analógico | un | 4 | Premissa | Para dampers motorizados |
| 5 | Sensor de pressão diferencial | 0-100 Pa, saída 4-20mA, display | un | 4 | Premissa | Monitoramento escada/antecâmara |
...
| # | Item | Especificação | UN | QTD | Fonte | Observação |
|---|------|--------------|-----|-----|-------|------------|
| 1 | Quadro de comando (QC-VENT) | Metálico, IP65, disjuntores termomagnéticos | un | 1 | Premissa | Centralizado na casa de máquinas |
| 2 | Soft-starter para ventilador | 7,5 CV, 220/380V, 3F, bypass | un | 2 | Premissa | 1 por ventilador |
| 3 | Cabo alimentação ventiladores | 4x6mm², 750V, anti-chama | m | 50 | Premissa | Quadro → ventiladores |
| 4 | Cabo de comando dampers/sensores | 2x2,5mm², 300V, blindado | m | 250 | Premissa | Interligação QC → campo |
| 5 | Eletroduto rígido PVC Ø1" | Anti-chama, fixação em shaft | m | 250 | Premissa | Passagem de cabos |
| 6 | Botoeira de acionamento manual | Emergência, com sinalização luminosa | un | 4 | Premissa | Térreo + casa de máquinas (2 por local) |
| 7 | Sinalização luminosa (em operação) | LED verde, 220V | un | 4 | Premissa | Indicação de sistema ativo |
...
| # | Item | Especificação | UN | QTD | Fonte | Observação |
|---|------|--------------|-----|-----|-------|------------|
| 1 | Controlador lógico programável (CLP) | 16 I/O, comunicação Modbus, fonte redundante | un | 1 | Premissa | Gerenciamento central |
| 2 | Interface com central de incêndio | Módulo de entrada (contato seco) | un | 1 | Premissa | Acionamento automático |
| 3 | IHM (Interface Homem-Máquina) | Touch-screen 7", IP65 | un | 1 | Premissa | Monitoramento em casa de máquinas |
| 4 | Software de supervisão (SCADA) | Licença, configuração, histórico de alarmes | un | 1 | Premissa | Registro de eventos |
| 5 | Sirene de alarme (falha sistema) | 220V, 110dB, estroboscópica | un | 2 | Premissa | Casa de máquinas + guarita |
...
### Equipamentos
- **Ventiladores centrífugos:** 2 un (5-7,5 CV cada)
- **Dampers corta-fogo 90min:** 64 un
- **Dampers motorizados:** 4 un
- **Sensores de pressão:** 4 un
- **Grelhas/difusores:** 42 un

### Dutos e Componentes
- **Duto vertical principal Ø600mm:** 200 m
- **Duto de derivação:** 60 m
- **Isolamento térmico:** 380 m²
- **Suportes:** 64 un

### Elétrica
- **Cabos de força:** 50 m
- **Cabos de comando:** 250 m
- **Eletrodutos:** 250 m
- **Quadro de comando:** 1 un
- **Soft-starters:** 2 un
...
|---|---------|---------------|
| 1 | **2 escadas pressurizadas** | Típico para edifício residencial de 32 pavimentos conforme NBR 9077 (população > 300 pessoas) |
| 2 | **Vazão 8.000-12.000 m³/h por escada** | NBR 14880: 0,5 m³/s por porta aberta + 3 portas simultâneas + infiltrações |
| 3 | **Pressão 400-600 Pa nos ventiladores** | Compensação de perdas de carga em dutos verticais de ~100m + singularidades |
| 4 | **Diferencial de pressão 25-50 Pa** | Faixa normativa NBR 14880 para escadas PF2 |
| 5 | **Dampers corta-fogo a cada pavimento** | Compartimentação vertical conforme IT 09/2019 (SP) |
| 6 | **Grelhas a cada 5 pavimentos** | Distribuição uniforme de pressão ao longo do shaft |
| 7 | **Duto Ø600mm** | Dimensionamento para vazão máxima com velocidade < 8 m/s (redução de ruído) |
| 8 | **Isolamento térmico 50mm** | Prevenção de condensação e manutenção de temperatura de insuflamento |
| 9 | **Alimentação por gerador** | Requisito de emergência NBR 14880 (sistema operante durante incêndio) |
| 10 | **Controle via CLP com interface para central de incêndio** | Acionamento automático obrigatório por norma |
...
**PENDÊNCIAS CRÍTICAS — Resolver ANTES de orçar:**
...
- [ ] **Localização e quantidade de grelhas/difusores** (extrair de prancha)
...
- [ ] **Memorial descritivo do sistema** (obter PDF completo do projetista)
- [ ] **Prancha de detalhes** (cortes, isométricos, detalhes de fixação)
...
### 9.2 Arquivos Necessários (SOLICITAR)
...
|---------|------|--------------------|----------|
| R00 | 2026-03-20 | RA_EVM_LEGAL_PROJETO_R05.dwg | Versão inicial — **PREMISSAS NÃO VALIDADAS** — aguardando memorial descritivo |
...
**Contingência sugerida:** 15-20% (incerteza por falta de dados)

**TOTAL COM BDI E CONTINGÊNCIA:** R$ 330.000 - 520.000

**Custo por pavimento:** R$ 10.300 - 16.250 (32 pavimentos)

---

*Briefing gerado por Cartesiano (subagente de extração) | Data: 2026-03-20*

*⚠️ VALIDAÇÃO OBRIGATÓRIA: Este documento foi gerado com base em premissas técnicas padrão devido à limitação de extração automática do arquivo DWG. Todos os quantitativos e especificações devem ser validados com o projeto executivo antes de utilização em orçamento.*
