...
> **Template expandido:** `TEMPLATE-INDICES-EXPANDIDO.md` (16 seções, ~24KB)
...
Copiar `TEMPLATE-INDICES-EXPANDIDO.md` para `<nome-projeto>-indices.md` e preencher todas as 16 seções:
...
| Template fonte | `TEMPLATE-INDICES-EXPANDIDO.md` | Referência com campos padronizados |
