...
# Medianas calibradas (R$/m², base CUB dez/23 = R$ 2.752,67)
# Recalibrado em 05/mar/2026 com 18 projetos normalizados p/ CUB base
MEDIANAS = {
    "Gerenciamento": 408.31,
    "Mov. Terra": 12.40,
    "Infraestrutura": 227.95,
    "Supraestrutura": 726.18,
    "Alvenaria": 147.73,
    "Impermeabilização": 50.00,
    "Instalações": 365.64,
    "Sist. Especiais": 190.04,
    "Climatização": 0,
    "Rev. Int. Parede": 169.75,
    "Teto": 67.43,
    "Pisos": 189.36,
    "Pintura": 131.49,
    "Esquadrias": 366.05,
...
def criar_aba_dados_projeto(wb, dados=None):
    ...
    campos = [
        ...
        ("CUB Base dez/23 (R$/m²)", dados.get("CUB_BASE", 2752.67) if dados else 2752.67),
...
def criar_aba_custos_macrogrupo(wb):
...
def criar_aba_notas(wb):
    ...
    notas = [
        ...
        "",
        "BASE DE CALIBRAÇÃO:",
        "- Mediana calibrada com 18 projetos reais executados entre 2022-2024",
...
def criar_aba_benchmark(wb):
    ...
    # Média da base (valores aproximados dos 8 projetos)
    medias_base = {
        "Gerenciamento": 380,
        "Infraestrutura": 210,
        "Supraestrutura": 680,
...
def gerar_planilha(output_path, dados_projeto=None, briefing_respostas=None):
    """
    ...
    criar_aba_dados_projeto(wb, dados_projeto)
    ...
    criar_aba_custos_macrogrupo(wb)
...
if __name__ == "__main__":
    ...
    output_dir = os.path.expanduser("~/clawd/orcamento-parametrico")
    ...
    gerar_planilha(rozzo_path, ROZZO_DADOS, ROZZO_BRIEFING)
    print()
    ...
    gerar_planilha(template_path, None, None)
    print()
