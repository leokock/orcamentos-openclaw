...
> Última atualização: 06/03/2026 (51 projetos — calibração atualizada com 30 projetos)
> PUs detalhados dos projetos 12-25: `orcamento-parametrico/PUs-NOVOS-PROJETOS.md`
> **Último projeto adicionado:** Yellowstone (JTA) — 8.072 m², CUB 1,22, 36 unidades (32 líquidos + 4 permuta), ~110 m² priv/AP, **Supraestrutura 21,6%** (altíssima), **Esquadrias 12%** (alto padrão), Gerenciamento 10,17% (eficiente), Pintura 6,27% (acima média)

---

## BRIEFING E PERGUNTAS

> **Template:** `orcamento-parametrico/BRIEFING-PARAMETRICO.md`
>
> **Workflow:** Ao receber um novo projeto:
> 1. Extrair dados do programa automaticamente (PDF/planilha)
> 2. Verificar se o briefing foi preenchido
> 3. **Se não preenchido:** fazer as 9 perguntas decisivas ao Leo, uma a uma, na ordem de impacto:
>    - Tipo de laje → Padrão de acabamento → Contenção → Prazo → Cobertura → Drywall/alvenaria → MO fachada → Nível lazer → Sistemas especiais
> 4. Rodar motor paramétrico com índices calibrados
> 5. Apresentar resultado + comparativo com projetos anteriores
> 6. Se receber planilha real: comparar, calibrar, atualizar esta base

---

## ESTRUTURA DA BASE

### Correção Temporal (CUB)

> **REGRA CRÍTICA:** Todo paramétrico tem uma data-base. Para comparar projetos de épocas diferentes ou gerar um orçamento atual, é necessário "trazer a valor presente" usando o CUB (Custo Unitário Básico da Construção).
>
> **Fórmula:** `Valor_atual = Valor_original × (CUB_atual / CUB_data_base)`
>
> **Fonte:** Sinduscon do estado (ex: Sinduscon-SC para obras em SC)
>
> **Regra prática:** Ao comparar índices de projetos diferentes, SEMPRE normalizar pela data-base do CUB antes de fazer média ou calibrar. Expressar custos em "X CUB" facilita comparação entre épocas.

### Fator Regional

> **REGRA:** Custos variam significativamente por região. Principais fatores:
> - MO: varia 15-30% entre regiões (litoral SC vs interior vs capital)
> - Materiais: frete impacta itens pesados (concreto, aço, cerâmica)
> - CUB regional: usar o CUB do estado como referência de comparação
>
> **Ao registrar um projeto:** SEMPRE incluir cidade/região + CUB/estado vigente na data-base.

### Projetos Registrados

| # | Projeto | Cidade/Região | Padrão | AC (m²) | UR | NP | NPT | Data-base | CUB ref. | R$/m² | Status |
|---|---------|--------------|--------|---------|----|----|-----|-----------|----------|-------|--------|
| 1 | CTN-IVC-LRJ | — | Alto | ref | ref | ref | ref | Jun/2024 | — | — | Regras extraídas |
| 2 | 2cinco4 Edition | Itapema/SC | Alto | 11.218 | 44 | 27 | 21 | Jun/2024 | 2.934,53 (Jun/25) | 3.457 | ✅ Completo (GE + CI) |
| 3 | Amalfi San Felice | SC (SFL) | Alto | 7.457 | 45 | 13 | 9 | Mar/2024 | — | 3.292 | ✅ Completo (GE + CI + Analítico) |
| 4 | BD Jardim Campeche | Florianópolis/SC | Alto | 3.633 | 20 | 7 | 4 | Jan/2026 | — | 4.491* | ✅ Completo (GE + CI + Analítico + Prazo) |
| 5 | Monolyt (Blue Heaven) | Balneário Camboriú/SC | Super Alto | 14.693 | 24 | 4+4 (2 torres) | 3+3 | Mai/2024 | 2.758,46 | 5.988 (2,17 CUB) | ✅ Completo (GE + CI + Analítico + Prazo) |
| 6 | Aquos Oasis Home (Blue Heaven) | Balneário Camboriú/SC | Super Alto | 7.192 | 12 | 4+4+4 (3 torres) | 3+3+3 | Ago/2024 | 2.811,86 | 9.534 (3,39 CUB) | ✅ Completo (GE + CI + Analítico + Prazo) |
| 7 | Redentor (Brasin) | Itapema/SC | Alto | 16.728 | 40 | 43 | 32 | Set/2023 | 2.752,32 | 4.043 (1,47 CUB) | ✅ Completo (GE + CI + Apresentação) |
| 8 | Catena (CKock) | SC | Médio-Alto | 9.242 | 48 | 30 | — | Nov/2025 | 3.008,84 | 3.376 (1,12 CUB) | ✅ Completo (Param + CI + Apresentação) |
| 9 | Zapata (CKock) | Porto Belo/SC | Médio | 7.533 | 36 + 2UC | 24 | 18 | Set/2025 | 2.993,04 | 3.193 (1,07 CUB) | ✅ Completo (Param + CI + Apresentação) |
| 10 | Colline de France RESID | Miguel Pereira/RJ | Alto | 21.510 | 60 | 23 | 13 | Mar/2025 | 2.303,36 (CUB/RJ) | 4.069 (1,77 CUB) | ✅ Completo (GE + CI) |
| 11 | Colline de France HOTEL | Miguel Pereira/RJ | Super Alto | 6.049 | 36 quartos | 5 | 0 | Mar/2025 | 2.303,36 (CUB/RJ) | 6.889 (2,99 CUB) | ✅ Completo (GE + CI) |
| 12 | Costão do Santinho | Florianópolis/SC | Alto | 38.429 | 351 | 7 | — | Fev/2023 | — | 4.239* | ✅ GE (formato antigo) |
| 13 | Cota 365 (Afonso Pena) | Florianópolis/SC | Alto | 17.473 | 176 | 16 | 10 | Out/2024 | 2.846,12 | 3.367 (1,18 CUB) | ✅ Completo (GE + Apresentação) |
| 14 | D'Lohn Estreito | Florianópolis/SC | Alto | 13.148 | 84+5UC | 13 | 8 | Mar/2025 | 2.907,85 | 3.728 (1,28 CUB) | ✅ Completo (GE + MO + Apresentação) |
| 15 | Fasolo Villa Del Fiume | SC | Super Alto | 20.550 | — | 27 | 17 | Abr/2021 | — | 2.843* | ✅ GE + Apresentação (formato antigo) |
| 16 | Fasolo Elysium | SC | Alto | 6.965 | — | 29 | 19 | Jul/2020 | — | —* | ✅ GE (formato antigo) |
| 17 | Ferrazzo Viva Perequê | Porto Belo/SC | Alto | 5.576 | 36+2UC | 15 | 8 | Jul/2025 | 2.965,54 | 4.129 (1,39 CUB) | ✅ Completo (GE + CI + Apresentação) |
| 18 | EIS Jurerê Blue | Florianópolis/SC | Alto | 5.348 | 66+3UC | 14 | 8 | Nov/2025 | — | —* | ✅ GE + CI + Paramétrico |
| 19 | Meia Praia 298 | Itapema/SC | Alto | 10.618 | 36+5UC | 26 | 18 | Jun/2024 | 2.725,79 | 3.535 (1,30 CUB) | ✅ Completo (GE + Analítico + Apresentação) |
| 20 | Meia Praia Eternity | Itapema/SC | Alto | 11.893 | 46+5UC | 28 | 23 | Jun/2024 | 2.725,79 | 3.482 (1,28 CUB) | ✅ Completo (GE + Analítico + Apresentação) |
| 21 | Meia Praia Lorenzo Gabriel | Itapema/SC | Alto | 8.525 | 70+3UC | 19 | 14 | Set/2024 | 2.841,51 | 3.778 (1,33 CUB) | ✅ Completo (GE + CI + Analítico + Apresentação) |
| 22 | Neuhaus Origem 3300 | SC | Alto | 14.516 | — | 33 | 18 | Jun/2024 | 2.793,27 | 4.152 (1,49 CUB) | ✅ Completo (GE + Analítico + Apresentação) |
| 23 | Pass-e Passione | Porto Belo/SC | Alto | 6.682 | — | — | 16 | Jun/2024 | 2.774,29 | 3.778 (1,36 CUB) | ✅ Apresentação + CI + Prazo |
| 24 | Pass Connect | Itajaí/SC | Alto | 13.144 | 156+1UC | 20 | 14 | Jun/2024 | 2.774,29 | 3.584 (1,29 CUB) | ✅ Completo (GE + Apresentação) |
| 25 | Sisa Wave Eurogarden | SC/PR | Super Alto | 80.722 (total) | 596+2UC | 42 | 38 | Nov/2024 | 2.430-2.999 | 4.060 (1,67 CUB médio) | ✅ Completo (GE Mall+Resid + Analítico + Apresentação) |
| 26 | Kirchner West Village | Itapema/SC | Alto | 10.723 | 44 | 21 | 15 | Dez/2023 | 2.752,67 | 2.816 (1,02 CUB) | ✅ Completo (Executivo → Índices) |
| 27 | Adore Level UP | Florianópolis/SC | Alto | 11.103 | 141 (88+33+20UC) | 7 | 4 | Ago/2025 | 2.911,91 | 3.629 (1,25 CUB) | ✅ Completo (Executivo → Índices) |
| 28 | Amalfi Maiori | Itajaí/SC | Alto | 8.367 | 60 | 18 | 11 | Jul/2023 | 2.747,90 | 3.010 (1,10 CUB) | ✅ Completo (Executivo → Índices Expandidos) |
| 29 | Amalfi Marine | Navegantes/SC | Médio-Alto | 4.499 | 27 | 14 | 9 | Jul/2023 | 2.750,52 | 3.136 (1,14 CUB) | ✅ Completo (Executivo → Índices Expandidos) |
| 30 | Be Brave Meraki | Itajaí/SC | Alto | 22.461 | 110 | 32 | 25 | Jan/2025 | 2.887,91 | 3.720 (1,29 CUB) | ✅ Completo (Executivo → Índices Expandidos) |
| 31 | AS Ramos Paessaggio | Balneário Camboriú/SC | Alto | 16.348 | 55 | 33 | 24 | Abr/2023 | 2.680,84 | 3.133 (1,17 CUB) | ✅ Completo (Executivo → Índices Expandidos) |
| 32 | ARV Ingleses Spot | Florianópolis/SC | Médio-Alto | 2.618 | 49 | 4 | 3 | Jul/2024 | 2.841,51 | 5.334 (1,88 CUB) | ✅ Completo (Executivo → Índices Expandidos) |
| 33 | Brasin Mario Lago (CTN-BRS-MLG) | Porto Belo/SC (Perequê) | Alto | 8.286 | ~39 | ~18 | 11 | Set/2022 | 2.623,42 | 2.835 (1,08 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) |
| 34 | Brava Mar à Vista (CTN-BRV-MVR) | Ilhéus/BA | Médio-Alto | 3.120 | 27 | 6 | 3 | Fev/2024 | 1.889,47 (CUB/BA) | 3.348 (1,77 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) |
| 35 | By Seasons - For Seasons Apartments (CTN-BSN-FSN) | Itapema/SC | Alto | 6.348,51 | 54 | ~18 | 14 | Set/2024 | 2.841,51 | 3.520 (1,24 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) |
| 36 | ETR Mediterrâneo Tower (CTN-ETR-MDT) | Itapema/SC | Alto/Altíssimo | 4.617,34 | 20 | 13 | 10 | Nov/2024 | 2.863,73 | 4.197 (1,47 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) |
| 37 | Exito - Residencial Oiti (CTN-EXT-OIT) | Itajaí/SC | Médio-Alto | 7.974,15 | ~54 | ~17 | 13 | Jan/2023 | 2.513,74 | 2.370 (0,94 CUB)* | ⚠️ INCOMPLETO (Infra R$0, Contenções R$0) — Índices Expandidos 16 seções |
| 38 | Lausanne Stand (CTN-STA-LAU) | Campinas/SP | Alto | 600,60 | 4 casas | N/A | N/A | Dez/2023 | 2.304,59 (CUB/SP R8) | 4.219 (1,83 CUB) CRU / 4.618 (2,00 CUB) DECORADO | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **PRIMEIRO PROJETO DE CASAS** |
| 39 | EZE Canto Grande - East Wind (CTN-EZE-CTG) | Bombinhas/SC (Canto Grande) | Alto | 1.611,55 | 8 | N/D | N/D | Mai/2022 | 2.470,83 | 3.627 (1,47 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) — ESCALA PEQUENA (1.612 m²) padrão alto (alumínio Gold, portas laqueadas, brise madeira, piscina, sauna, aspiração central) |
| 40 | Edifício Eliat - EZE Eilat (CTN-EZE-ELT) | Bombinhas/SC (José Amândio) | Alto | 1.767,30 | N/D | ~7 | 4 | Nov/2023 | 2.754,98 | 3.642 (1,32 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) — ESCALA PEQUENA (1.767 m²) padrão alto (porcelanato 90×90/120×120, vinílico dormitórios, alumínio Suprema, portas laqueadas, aspiração central, piscina em lazer + cobertura, brise alumínio amadeirado, forro madeira lazer) — ATENÇÃO: Instalações R$ 540/m² (50% acima topo faixa), Supra Embasamento 48% do total (garagem pesada), ETE Bombinhas, Adm obra zerada (conta EZE GO) |
| 41 | Scenarium Brava Norte (CTN-FGE-SCN) | Itajaí/SC (Brava Norte) | Super Alto | 42.277,77 | 142 | ~12/torre | 5 | Dez/2024 | 3.190,77 (R16-A) / 2.868,56 (médio) | 4.888 (1,54 CUB R16-A, 1,71 CUB médio) | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **4 TORRES** (Sunset, Breeze, Waves, Sunrise), **LAJE PROTENDIDA**, **STEEL FRAME VEDAÇÃO**, super alto padrão (travertino, alumínio gold 32mm, aspiração central, piscinas aquecidas). Primeiro projeto **FG Empreendimentos** na base. Ritmo 863 m²/mês (181% acima médias — paralelização de torres). Prazo 49 meses. Instalações R$ 349/m² (dentro faixa estável). Alvenaria R$ 319/m² (Steel Frame explica). |
| 42 | Fonseca Neto Estoril (CTN-FSN-EST) | Camboriú/SC (Tabuleiro) | Médio-Alto | 14.491,98 | 112 | 20 | 12×2 torres | Dez/2025 | 3.008,84 | 3.545 (1,18 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **⚠️ ALVENARIA ESTRUTURAL** (1º da base — blocos concreto 3-6 MPa, 14×19 cm). 2 torres (A + B), 110 UR + 2 UC. HC ø60/70/80 (137 estacas, 2.825m). Protensão laje G3. **FACHADA VENTILADA** (R$ 702,08/un, 2º da base após Blue Coast FG). Instalações R$ 623/m² (15% acima faixa, MO elétrica=MO hidro R$988k — template?). Imprevistos 1,26% (abaixo benchmark 2-5%). 41 abas Visus BIM. ETE inclusa (R$ 175k). Mobiliário R$ 1.322k (R$ 1.158/m² lazer). |
| 43 | GDI Playa Negra (CTN-GDI-PLN) | Florianópolis/SC (Agronômica) | Médio-Alto | 8.518,60 | 71 | 12 | 6 | Ago/2024 | 2.841,51 | 4.347 (1,53 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **PAREDE DIAFRAGMA** (contenção especializada R$ 511k + cortina R$ 275k). 2 subsolos. 69 UR + 2 UC. Térreo com transição estrutural massiva (51.831 kg aço — 4× tipo). 28 churrasqueiras (88,84 m² refratário). Pele de vidro 103,5 m² (R$ 1.288/m²). Amenidades premium (infra carro elétrico, fechadura eletrônica, aquecimento central). GTA 33,2% INCLUI TERRENO (R$ 4.048.500 — 3 lotes). Drenagem complexa R$ 118k (McDrain). Prazo 30 meses. |
| 44 | Atlantia (H Empreendimentos) | Porto Belo/SC | Médio-Alto | 12.828,33 | 121 (117+4UC) | 20 | 13 | Nov/2024 | 2.863,73 | 3.151 (1,10 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **19º PROJETO DA BASE**. 121 unidades, 4 pavimentos garagem, prazo 65 meses (o mais longo da base). Todos macrogrupos dentro das faixas. Dados detalhados limitados (sem levantamento de áreas, sem breakdown supra/infra). Esquadrias 13,94% (alto). Ritmo 197 m²/mês (baixo, possivelmente por prazo estendido). CUB 1,10 competitivo para Porto Belo médio-alto. Normalizado para dez/2023. |
| 45 | Nouve 354 (Holze Empreendimentos) | Porto Belo/SC | Médio-Alto | 5.438,90 | 26 | N/D | N/D | Set/2022 | 2.623,42 | 3.055 (1,11 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **21º PROJETO DA BASE**. 26 unidades, 2 elevadores, prazo 34 meses. Gerenciamento alto (R$ 512/m² — escala pequena + prazo longo). Ritmo 160 m²/mês (muito baixo). Instalações R$ 253/m² (estimadas por índices, não quantitativo real). Fachada diferenciada (Brise + Cobogó + Pele vidro + Textura). Mini grua rateada 3 obras. Forma compensado plastificado 4 reutilizações. Equipamentos piscina/spa. Dados estruturais não disponíveis (orçamento sem levantamento detalhado). Normalizado Set/22 → Dez/23 (fator 1,0493). |
| 46 | Brisa da Armação (Hacasa - CTN-HAC-BRA) | Penha/SC | Alto | 6.907,17 | N/D | N/D | Subsolo+Térreo+Torres A(5)+B(6)+Ático | Mar/2025 | 2.907,85 | 4.110 (1,41 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **20º PROJETO CALIBRAÇÃO**. Alto padrão, 2 torres (A 5 tipos pav + B 6 tipos pav), subsolo c/ contenção perimetral (R$ 896k), 5 elevadores, automação, piscinas. AT 2.390 m², CA 2,89. Gerenciamento 12,26% (acima mediana — complexidade gestão). **ALERTAS:** Mov.Terra R$ 49/m² (+245% vs mediana — terreno desafiador), Infra R$ 512/m² (+122% vs mediana — contenção + subsolo), Impermeab R$ 86/m² (+67% — piscinas + subsolo). Fachada R$ 100/m² (-37% — sistema simplificado?). Louças R$ 33/m² (abaixo alto padrão). Imprevistos 1,00% (conservador). Normalizado Mar/25 → Dez/23 (fator 0,9466). |
| 47 | Sense 106 (Holze Empreendimentos - CTN-HLZ-S106) | Porto Belo/SC | Médio-Alto | 8.700,00 | 60 | 27 | N/D | Set/2024 | 2.844,00 | 3.464 (1,22 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **22º PROJETO CALIBRAÇÃO**. 60 unidades, 27 pavimentos, AT 720 m², prazo 48 meses. Lazer completo, piso vinílico aptos, infra climatização + painéis solares + carros elétricos. Gerenciamento 16,1% (acima mediana — escala média + prazo longo). **ALERTAS:** Supraestrutura R$ 836/m² (+57% vs KIR — possível laje complexa), Ritmo 181 m²/mês (-41% vs benchmark ~300 — prazo longo). **DENTRO FAIXAS:** Instalações R$ 312/m² (280-400), Infraestrutura R$ 226/m² (topo 115-235), Alvenaria R$ 118/m², Esquadrias R$ 229/m², Pintura R$ 136/m², Fachada R$ 92/m². **ABAIXO:** Teto R$ 62/m² (esperado 80-120), Impermeabilização R$ 48/m² (55-90), Sist.Especiais R$ 118/m² (170-240 com solar/AC/carro). Normalizado Set/24 → Dez/23 (fator 0,9679). |
| 48 | Homeset Garden (Homeset/Humeset - CTN-HMS-GRD) | Itajaí/SC | Médio | 7.959,45 | 160 | ~20 | ~13 | Dez/2022 | 2.623,42 | 2.748 (1,05 CUB) / 2.884 norm. | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **23º PROJETO CALIBRAÇÃO**. **⚠️ ALVENARIA ESTRUTURAL** (1º da base com este sistema). 160 unidades, 4 elevadores, prazo 29 meses. Laje pré-moldada treliçada + lajota cerâmica, HC 30 MPa, corte/dobra em indústria, 4 guinchos de coluna + balancim. **NOTA CRÍTICA:** Alvenaria é ESTRUTURAL (não vedação). Supraestrutura R$ 221/m² + Alvenaria R$ 348/m² = **Estrutura Total R$ 569/m² (19,7%)**. Métricas de supra/alvenaria não são diretamente comparáveis com projetos em concreto armado. Instalações R$ 364/m² (dentro faixa estável). Gerenciamento R$ 432/m² (topo da faixa — escala média + prazo curto). Normalizado Dez/22 → Dez/23 (fator 1,0493). |
| 49 | Águas de Março (Inbrasul Empreendimentos - CTN-INBR-ADM) | Navegantes/SC | Médio-Alto | 6.538,41 | 45 | N/D | N/D | Jan/2023 | 2.651,17 | 3.528 (1,33 CUB) / 3.663 norm. | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **24º PROJETO CALIBRAÇÃO**. 45 unidades, prazo 41 meses. HC 40-60cm, concreto 40 MPa estacas / 35 MPa blocos / 30-35 MPa supra, forma plastificada, **corte/dobra EM OBRA**. **Consultoria CINDACTA 41 meses** (exigência aeronáutica Navegantes). **ALERTA CRÍTICO:** Gerenciamento R$ 1.042/m² (28,4% — **+141% vs mediana R$ 431/m²**). Gerenciamento original R$ 7.834.510 (32%) incluía R$ 1.275.000 de Marketing Online + Comissão de Vendas (excluído da calibração). Mesmo após exclusão, gerenciamento construtivo = R$ 6.559.510 (28,4%) permanece MUITO ALTO. Possíveis causas: consultoria CINDACTA, prazo longo (41 meses), complexidade gestão Navegantes. **SEM IMPREVISTOS** (R$ 0 — risco alto, benchmark 2-5%). **DENTRO FAIXAS:** Infraestrutura R$ 150/m², Supraestrutura R$ 637/m², Alvenaria R$ 134/m², Instalações R$ 284/m², Rev.Int.Parede R$ 172/m², Pisos R$ 201/m², Esquadrias R$ 307/m², Fachada R$ 140/m². Normalizado Jan/23 → Dez/23 (fator 1,0383). |
| 50 | Stella Marina / Stella Marina (Indepy - CTN-IND-CP) | **São Paulo/SP** | Alto | 4.245,77 | 103 | N/D | N/D | Out/2022 | **R$ 2.276,34 (CUB/SP)** | 4.071 original / **4.923 norm.** (1,79 CUB) | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **26º PROJETO CALIBRAÇÃO**. **PRIMEIRO PROJETO SÃO PAULO** na base (CUB/SP, não SC). 103 unidades **COMPACTAS** (~41 m²/UR — menor da base). **ALERTA CRÍTICO:** Esquadrias R$ 598/m² (12,15% do total — 2º maior macrogrupo). Gerenciamento R$ 969/m² (19,68% — +124% vs mediana). Instalações R$ 615/m² (+69% vs mediana). Supraestrutura R$ 843/m² (+20%). Infraestrutura R$ 354/m² (+55%). **Normalizado CUB SP→SC** (fator 1,2092 — inflação + diferença regional). **SEM LEVANTAMENTO QUANTITATIVO DETALHADO** (apenas resumo macrogrupos). Contenções R$ 31/m² (8,9% infra). Fachada R$ 99/m² (-30% vs mediana). Imprevistos 0,98%. Possíveis drivers de custo: região SP, escala pequena (4.246 m²), unidades compactas, esquadrias premium. |
| 50 | Opus House (Inbrasul Empreendimentos - CTN-INB-OPH) | Navegantes/SC | Alto | 4.410,50 | 36 | N/D | N/D | Dez/2022 | 2.643,16 | 3.799 (1,44 CUB) / 3.754 norm. | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **25º PROJETO CALIBRAÇÃO**. **MESMO CLIENTE** que Águas de Março (Inbrasul). 36 unidades, prazo 48 meses. HC, concreto 30/40 MPa, **corte/dobra EM OBRA**, elevador cremalheira, forma plastificada. **Consultoria CINDACTA 48 meses** (aeroporto Navegantes). **ALERTA CRÍTICO:** Gerenciamento R$ 1.071/m² (28,5% — **+144% vs mediana R$ 439/m²**). Gerenciamento original R$ 5.396.049 (32,2%) incluía R$ 860k de Marketing Online (R$ 300k) + Comissão Vendas (R$ 560k) — excluído da calibração. Mesmo padrão metodológico do Águas de Março. **CUB ratio 1,44 (original) / 1,36 (calibrado)** — **MUITO ALTO** para Navegantes, 32% acima do Águas de Março (1,03 calibrado). Escala menor (4.410 m²) + prazo longo (48m) amplificam custos fixos. **RITMO 91,9 m²/mês** — 70% abaixo benchmarks (306-308 m²/mês). **SEM IMPREVISTOS** (R$ 0). **ABAIXO FAIXAS:** Mov.Terra R$ 6/m², Infra R$ 100/m², Alvenaria R$ 91/m², Impermeab R$ 41/m², Rev.Int.Parede R$ 77/m², Teto R$ 33/m², Pisos R$ 56/m². **DENTRO FAIXAS:** Supra R$ 604/m², Instalações R$ 416/m², Sist.Especiais R$ 168/m², Pintura R$ 88/m², Esquadrias R$ 304/m², Fachada R$ 111/m². Normalizado Dez/22 → Dez/23 (fator 1,0414). |
| 51 | Yellowstone (JTA - CTN-JTA-YLS) | N/D | Alto | 8.071,79 | 36 | N/D | N/D | Fev/2024 | 2.753,62 | 3.349 (1,22 CUB) / 3.348 norm. | ✅ Completo (Executivo → Índices Expandidos 16 seções) — **30º PROJETO CALIBRAÇÃO**. 36 UR (32 líquidos + 4 permuta), ~110 m² priv/AP. **SUPRAESTRUTURA 21,6%** (R$ 722/m² — **ALTÍSSIMA**, +1,5% acima mediana de % — estrutura complexa ou taxa de aço elevada). **ESQUADRIAS 12%** (R$ 398/m² — alto padrão). **Gerenciamento 10,17%** (R$ 340/m² — eficiente, abaixo mediana). **Pintura 6,27%** (R$ 210/m² — ACIMA MÉDIA, +63% vs mediana R$ 128/m²). **DENTRO FAIXAS:** Infraestrutura R$ 188/m², Alvenaria R$ 100/m², Instalações R$ 365/m², Sist.Especiais R$ 163/m², Impermeabilização R$ 52/m², Rev.Int.Parede R$ 170/m², Pisos R$ 181/m², Fachada R$ 133/m², Complementares R$ 235/m², Imprevistos 1,5%. **ABAIXO:** Teto R$ 35/m² (vs 62 med — forro simples), Alvenaria R$ 100/m² (vs 146 med — menos compartimentação). **ZERADO:** Climatização R$ 0, Louças R$ 0 (embutidos). Normalizado Fev/24 → Dez/23 (fator 0,99966 — praticamente 1.0). |
...
> **Referência de arquivo detalhado:** `orcamento-parametrico/PUs-NOVOS-PROJETOS.md`
