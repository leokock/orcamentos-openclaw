...
> Criado: 05/03/2026 | Atualizado: 11/03/2026
> **Base atual:** 75 projetos calibrados, 205 projetos extraídos em 5 formatos (resumo: 99, detalhado: 72, gerenciamento: 52, sienge: 22, analítico: 15).
...
- **Recalibração:** após cada novo executivo processado (decisão Leo 05/mar/2026) — não esperar acumular
